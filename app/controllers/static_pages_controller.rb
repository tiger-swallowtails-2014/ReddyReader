class StaticPagesController < ApplicationController
  ...
  def speed_test_result
    ...
    render json: {author: recent_book.author, image_url: recent_book.image_url, wpm: reading_test.wpm, result: reading_test.time_to_read, title: recent_book.title, time_per_page: reading_test.time_per_page, page_count: recent_book.page_count}.to_json
  end
